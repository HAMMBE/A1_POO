...
namespace TP4.VaisseauEnfant
{
    class ViperMKII:Vaisseau
    {
            public ViperMKII()
            {
                ...
                armurerieVaisseau.Armes.Add(new Arme("Mitrallieuse", 2, 3, 1, Type.Guidé));
                armurerieVaisseau.Armes.Add(new Arme("EMG", 1, 7, 2, Type.Guidé));
                armurerieVaisseau.Armes.Add(new Arme("Torpille", 4, 100, 2, Type.Guidé));
